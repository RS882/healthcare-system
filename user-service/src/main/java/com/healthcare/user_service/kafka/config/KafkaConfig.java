...
import com.healthcare.user_service.kafka.properties.KafkaBootstrapServersProperties;
...
public class KafkaConfig {
    ...
    private final KafkaBootstrapServersProperties kafkaBootstrapServersProperties;

    @Bean
    public ProducerFactory<String, UserRegisteredEvent> userRegisteredProducerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaBootstrapServersProperties.bootstrapServers());
    ...
    public ConsumerFactory<String, UserRegisteredEvent> userRegisteredConsumerFactory() {
        ...
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaBootstrapServersProperties.bootstrapServers());
    ...
    public NewTopic userRegisteredTopic() {
        return TopicBuilder.name("user.registered.v1")
                .partitions(3)
                .replicas(1)
                .build();
    }
