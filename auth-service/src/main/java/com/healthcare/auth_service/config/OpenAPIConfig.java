...
public class OpenAPIConfig {
    ...
    public OpenAPI openAPI() {
        ...
        Components components = new Components()
                ...
                // 400
                .addExamples("Error400LoginMissingField", ex400Login())
                ...
                // 503
                .addExamples("Error503LoginServiceUnavailable", ex503(LOGIN_URL))
    ...
    private static Example ex400Login() {
        return ex(
                ...
                errorExample(HttpStatus.BAD_REQUEST, LOGIN_URL,
                        "Password cannot be empty.",
    ...
    private static Example ex401Login() {
        return ex(
                "User unauthorized.",
                "User unauthorized.",
                errorExample(HttpStatus.UNAUTHORIZED, LOGIN_URL,
