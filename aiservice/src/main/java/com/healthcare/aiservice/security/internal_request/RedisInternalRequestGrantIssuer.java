...
import com.healthcare.aiservice.exception.rest_exception.InternalRequestGrantCreationException;
import com.healthcare.aiservice.exception.rest_exception.InternalRequestGrantUnavailableException;
...
public class RedisInternalRequestGrantIssuer
    ...
    private UUID saveGrant(InternalRequestGrant grant) {
        ...
        try {
            for (int attempt = 1;
                ...
                UUID internalRequestId = requestIdGenerator.generate();
    ...
    private String serialize(InternalRequestGrant grant) {
        try {
